package com.example.atat.Bootstrap;

import com.example.atat.domains.*;
import com.example.atat.repository.RecipeRepository;
import com.example.atat.repository.UnitOfMeasureRepository;
...
public class RecipeBootStrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes(){
        ...
        guacRecipe.setSource("simpleRecipe.com");
        ...
        tacosRecipe.setSource("SimpleRecipe.com");
